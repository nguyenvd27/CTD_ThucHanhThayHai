...
int main() {
  ...
  //dki 1 doi tuong vao block hien tai  
  declareObject(obj);
  ...
  declareObject(obj);
    ...
    obj = CreateTypeObject("Vector");
    obj->typeAttrs->actualType = makeArrayType(100,makeIntType());
    declareObject(obj);

    //obj = CreateTypeObject("Vector");
    // obj = CreateVariableObject("X");
    // obj2 = CreateTypeObject("Vector");
    // obj-> varAttrs -> type = obj2->type ;
    // declareObject(obj);
